 ...
 **/
@Slf4j
public class TransDictCodeStrategy extends AbstractTransDictStrategy {
    ...
    public TransDictEnum support() {
        return TransDictEnum.DICT_CODE;
    }
    ...
    protected void writeValue(DictExtraDTO fieldContent, String writeFiledName, String dictType, String dictValue) {
        SysDictItemDTO sysDictItemDTO = ROptional.of(sysDictClient.findSysDictDTO(dictType, dictValue)).getData().orElse(null);
