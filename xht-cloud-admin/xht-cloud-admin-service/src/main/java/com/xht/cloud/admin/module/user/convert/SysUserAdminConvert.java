...
public interface SysUserAdminConvert extends IBaseConvert<SysUserAdminCreateRequest, SysUserAdminUpdateRequest, SysUserAdminQueryRequest, SysUserAdminResponse, SysUserAdminDO> {
}
