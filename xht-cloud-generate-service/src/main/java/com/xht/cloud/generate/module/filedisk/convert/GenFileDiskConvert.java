...
public interface GenFileDiskConvert extends IBaseConvert<GenFileDiskCreateRequest, GenFileDiskUpdateRequest, GenFileDiskQueryRequest, GenFileDiskResponse, GenFileDiskDO> {
}
