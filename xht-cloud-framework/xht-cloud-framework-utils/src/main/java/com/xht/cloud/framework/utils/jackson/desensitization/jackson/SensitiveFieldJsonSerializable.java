package com.xht.cloud.framework.utils.jackson.desensitization.jackson;
...
import com.xht.cloud.framework.utils.jackson.desensitization.convert.ISensitiveFieldConvert;
import com.xht.cloud.framework.utils.jackson.desensitization.factory.SensitiveFieldConvertFactory;
...
public class SensitiveFieldJsonSerializable extends JsonSerializer<String> implements ContextualSerializer {
    ...
    public void serialize(String source, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        if (Objects.isNull(iSensitiveFieldConvert)) {
            throw new SysException("You used the annotation `@SensitiveField` but did not inject `ISensitiveFieldConvert`");
        }
